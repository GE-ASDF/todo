...
module.exports = [
    ...
    router.post("/tasks/update",authenticateMiddleware,verifyToken,tasksCreateValidations.tasksUpdateValidations,tasksCreateValidations.checkRules ,PrivateControllers.tasks.update),
